function [x,flag,relres,iter,resids] = fgmres(A, b, tol, maxit, P, x0)
%modified from https://github.com/oseledets/TT-Toolbox/blob/master/solve/fgmres.m
...
for it=1:max_iters
    ...
    for j=1:restart
        ...
        if (resid<tol_exit); flag=0;break; end;
    end;
    ...
    if (resid<tol_exit); flag=0; break; end; %best outcome
end;
